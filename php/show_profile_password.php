...
// TODO: Get profile data from database to get all the info that are not in the session
$id = $_SESSION['id'];
        ...
        <div class="row">
            <div class="col-md-3 ">
                <div class="list-group ">
                    <a href="show_profile.php" class="list-group-item list-group-item-action ">Dashboard</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="change_password.php" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="confirm" class="col-4 col-form-label">Confirm New Password</label>
                                        <div class="col-8">
                                            <input id="confirm" name="confirm" placeholder="Confirm New Password" class="form-control here" type="password" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
